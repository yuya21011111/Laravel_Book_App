        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            <div>
                <p class="text-sm text-gray-700 leading-5">
                    <span class="text-blue-600 font-medium">{{ $paginator->total() }}</span>
                    <span class="text-blue-600">件中</span>
                    @if ($paginator->firstItem())
                        <span class="text-blue-600 font-medium">{{ $paginator->firstItem() }}</span>
                      <span class="text-blue-600">件〜</span>
                        <span class="text-blue-600 font-medium">{{ $paginator->lastItem() }}</span>
                    @else
                        {{ $paginator->count() }}
                    @endif
                    <span class="text-blue-600">件</span>
